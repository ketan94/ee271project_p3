...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/home/ketan94/tars/assigns/ee271_tmp/assignment3/rtl/dff3.vp');
# START USER CODE FROM /home/ketan94/tars/assigns/ee271_tmp/assignment3/rtl/dff3.vp PARSED INTO PACKAGE >>>
# line 1 "/home/ketan94/tars/assigns/ee271_tmp/assignment3/rtl/dff3.vp"
print { $self->{OutfileHandle} } '/*';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } ' This is a three dimentional array of DFFs';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } ' */';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '/* ***************************************************************************';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '		input logic ['; print { $self->{OutfileHandle} } $bitwidth-1; print { $self->{OutfileHandle} } ':0]  in['; print { $self->{OutfileHandle} } $array_size1-1; print { $self->{OutfileHandle} } ':0]['; print { $self->{OutfileHandle} } $array_size2-1; print { $self->{OutfileHandle} } ':0], ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '		input logic 		       clk, reset, en, ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '		output logic ['; print { $self->{OutfileHandle} } $bitwidth-1; print { $self->{OutfileHandle} } ':0] out['; print { $self->{OutfileHandle} } $array_size1-1; print { $self->{OutfileHandle} } ':0]['; print { $self->{OutfileHandle} } $array_size2-1; print { $self->{OutfileHandle} } ':0]';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '		);	';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   ';print { $self->{OutfileHandle} } "\n"; 
    my @dffs = ();
...
# <<< END USER CODE FROM /home/ketan94/tars/assigns/ee271_tmp/assignment3/rtl/dff3.vp PARSED INTO PACKAGE
