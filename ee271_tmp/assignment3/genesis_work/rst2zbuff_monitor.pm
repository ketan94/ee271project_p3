...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/home/ketan94/tars/assigns/ee271_tmp/assignment3/verif/rst2zbuff_monitor.vp');
# START USER CODE FROM /home/ketan94/tars/assigns/ee271_tmp/assignment3/verif/rst2zbuff_monitor.vp PARSED INTO PACKAGE >>>
# line 1 "/home/ketan94/tars/assigns/ee271_tmp/assignment3/verif/rst2zbuff_monitor.vp"
print { $self->{OutfileHandle} } '/*';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } ' * rst2zbuff monitor ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } ' * ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } ' * This module monitors the outpus from rast';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } ' * to a hypothetical zbuffer.  The outputs';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } ' * are driven to a human readable file';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } ' * ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } ' * ';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '   assert property( sig_eq_con( rst, sample_RnnS[0] , hit_R18S[0]  , 1\'b1 )); //will change to something else';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   assert property( sig_eq_con( rst, sample_RnnS[1] , hit_R18S[1]  , 1\'b1 )); //will change to something else';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   assert property( sig_eq_con( rst, color_RnnU[0]  , color_R18U[0]  , 1\'b1 )); //Should Match';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   assert property( sig_eq_con( rst, color_RnnU[1]  , color_R18U[1]  , 1\'b1 ));';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   assert property( sig_eq_con( rst, color_RnnU[2]  , color_R18U[2]  , 1\'b1 ));';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   ';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '	 ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	 if( validSamp_RnnH ) begin';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	    // Needs to be parameterized based on vertex and '; print { $self->{OutfileHandle} } $axis; print { $self->{OutfileHandle} } ' -TODO JB';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	    ';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '	    $fwrite( file , "\\n\\t\\t" );';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	    $fwrite( file , "sample.x:%f\\t",  '; print { $self->{OutfileHandle} } unFix('hit_R18S[0]', $radix); print { $self->{OutfileHandle} } '  );';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	    $fwrite( file , "sample.y:%f\\t",  '; print { $self->{OutfileHandle} } unFix('hit_R18S[1]', $radix); print { $self->{OutfileHandle} } '  );';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	    $fwrite( file , "color.R:%f\\t",   '; print { $self->{OutfileHandle} } unFix('color_RnnU[0]', $radix); print { $self->{OutfileHandle} } ' );';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } ' 	    $fwrite( file , "color.G:%f\\t",   '; print { $self->{OutfileHandle} } unFix('color_RnnU[1]', $radix); print { $self->{OutfileHandle} } ' );';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	    $fwrite( file , "color.B:%f\\t",   '; print { $self->{OutfileHandle} } unFix('color_RnnU[2]', $radix); print { $self->{OutfileHandle} } ' );';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '	    $fwrite( file , "@%0t: Invalid Sample \\n" , $time );';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	 end    ';print { $self->{OutfileHandle} } "\n"; 
...
# <<< END USER CODE FROM /home/ketan94/tars/assigns/ee271_tmp/assignment3/verif/rst2zbuff_monitor.vp PARSED INTO PACKAGE
