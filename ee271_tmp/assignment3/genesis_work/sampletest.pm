...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/home/ketan94/tars/assigns/ee271_tmp/assignment3/rtl/sampletest.vp');
# START USER CODE FROM /home/ketan94/tars/assigns/ee271_tmp/assignment3/rtl/sampletest.vp PARSED INTO PACKAGE >>>
# line 1 "/home/ketan94/tars/assigns/ee271_tmp/assignment3/rtl/sampletest.vp"
...
print { $self->{OutfileHandle} } ' * ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } ' *    0 >  ( x_2 - x_1 ) * ( y_s - y_1 ) - ( x_s - x_1 ) * ( y_2 - y_1 )';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } ' *  ';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '   logic signed ['; print { $self->{OutfileHandle} } $sig_fig; print { $self->{OutfileHandle} } '-1:0] 	 poly_shift_R16S['; print { $self->{OutfileHandle} } $verts; print { $self->{OutfileHandle} } '-1:0][1:0]; // Micropolygon after coordinate shift ';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '   logic signed [2*'; print { $self->{OutfileHandle} } $shortSF; print { $self->{OutfileHandle} } '-1:0] 	 dist_lg_R16S['; print { $self->{OutfileHandle} } $edges; print { $self->{OutfileHandle} } '-1:0]; // Result of x_1 * y_2 - x_2 * y_1';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   logic 				 hit_valid_R16H ; // Output (YOUR JOB!)';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   logic signed ['; print { $self->{OutfileHandle} } $sig_fig; print { $self->{OutfileHandle} } '-1:0] 	 hit_R16S['; print { $self->{OutfileHandle} } $axis; print { $self->{OutfileHandle} } '-1:0]; // Sample position';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // Signals in Access Order ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //////// DECLARE OTHER INTERMEDIATE SIGNALS YOU NEED';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
    if( $verts == 3 ) {
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //////// BEGIN YOUR IMPLEMENTATION';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // Your job is to produce the value for hit_valid_R16H signal, which indicates whether a sample lies inside the micropolygon.';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // hit_valid_R16H is high if validSamp_R16H && sample inside micropolygon (with back face culling)';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // Consider the following steps:';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //// (1) Shift X, Y coordinates such that the fragment resides on the (0,0) position.';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //// (2) Organize edges (form three edges for triangles)';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   always_comb begin';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //// (3) Calculate distance x_1 * y_2 - x_2 * y_1';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
	 for( my $i = 0 ; $i < $edges ; $i++) {
print { $self->{OutfileHandle} } '   always_comb begin';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      dist_lg_R16S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } '] = edge_R16S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } '][0][0] * edge_R16S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } '][1][1] -  edge_R16S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } '][0][1] * edge_R16S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } '][1][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   end	    ';print { $self->{OutfileHandle} } "\n"; 
    }
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //// (4) Check distance and assign hit_valid_R16H.';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '	always_comb begin';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '   end ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   assign hit_valid_R16H = & {edge_chk1_R16[2:0], validSamp_R16H}; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //////// END YOUR IMPLEMENTATION';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
    } elsif( $edges == 5 ) {
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
# <<< END USER CODE FROM /home/ketan94/tars/assigns/ee271_tmp/assignment3/rtl/sampletest.vp PARSED INTO PACKAGE
